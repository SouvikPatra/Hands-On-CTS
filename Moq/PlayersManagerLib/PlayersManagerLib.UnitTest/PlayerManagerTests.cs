...
namespace PlayersManagerLib.UnitTest
{
    ...
    public class PlayerManagerTests
    {
        ...
        [TestCase(" ")]
        [TestCase(null)]
        public void RegisterNewPlayer_NameIsNullOrWhiteSpace(string name)
        {
        ...
        [Test]
        [TestCase("Sachin")]
        public void RegisterNewPlayer_PlayerExistInDb(string name)
        {
        ...
        [Test]
        [TestCase("Sachin")]
        public void RegisterNewPlayer_AddNewPlayer(string name)
        {
